...
test_data_single_20 = Data(
    ...
    [
        TableData(
            "json_lines1",
            [
                "num_ratings", "support_threads", "downloaded", "last_updated", "added", "num",
                "hoge",
            ],
            [
                {
...
class Test_JsonLinesTableFileLoader_load(object):
    ...
    @pytest.mark.parametrize(
        ...
        [
            [
                test_data_single_01.value, "json_lines1.jsonl", "%(key)s",
                test_data_single_01.expected
            ], [
                test_data_single_02.value, "json_lines1.jsonl", "%(key)s",
                test_data_single_02.expected
            ], [
                test_data_single_20.value, "json_lines1.jsonl", "%(key)s",
